  ...
  requests: router({
    create: protectedProcedure
      .input(z.object({
        ...
        farmId: z.number().min(1, "Fazenda é obrigatória"),
        farmName: z.string().min(1, "Fazenda é obrigatória"),
        harvestId: z.number().min(1, "Safra é obrigatória"),
        harvestName: z.string().min(1, "Safra é obrigatória"),
